...
import { getStatistics, getAnalyses } from '../services/storageService';
import {
  ChartBarIcon,
  DocumentTextIcon,
  AcademicCapIcon,
...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const recentAnalyses = getAnalyses(5); // Get last 5 analyses
      
      setDashboardData({
        totalResumes: stats.totalAnalyses,
        averageScore: stats.averageScore,
        improvements: stats.improvementRate,
        recentAnalyses: recentAnalyses,
        skillTests: 0, // Not implemented yet
        interviewSessions: 0, // Not implemented yet
      });
    } catch (error) {
